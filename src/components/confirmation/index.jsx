...
// Services
import { getOrderByIdService } from "../../services/OrderServices.ts";
...
const Confirmation = () => {
  ...
  return (
    <Layout>
      <div
        className="container"
        style={{ maxWidth: 780, padding: "2rem 1rem 3rem" }}
      >
        {/* ── Success Banner ──────────────────────────────────── */}
        <SuccessBanner />
        ...
        <div style={styles.card}>
          <div className="row g-0">
            ...
            <div className="col-md-6" style={styles.cardSection}>
              ...
              <InfoRow
                label="Status"
                value={<StatusBadge status={orderData.status} />}
              />
              <InfoRow
                label="Payment"
            ...
            <div
              className="col-md-6"
              style={{ ...styles.cardSection, ...styles.cardSectionRight }}
            >
        ...
        {/* ── Items Table ─────────────────────────────────────── */}
        <div style={styles.card}>
          <h6 style={{ ...styles.sectionTitle, padding: "1rem 1.25rem 0" }}>
            Items Ordered
          </h6>
            ...
            <table className="table mb-0" style={{ fontSize: "0.9rem" }}>
              <thead>
                <tr style={styles.tableHead}>
                  ...
                  <th style={styles.th} className="text-end">
                    Price
                  </th>
          ...
          <div style={styles.summaryBlock}>
            ...
            <SummaryRow
              label="Shipping"
              value={formatCurrency(orderData.shipping_charges)}
            />
            <SummaryRow
              label="Discount"
            ...
            <SummaryRow
              label="Grand Total"
              value={formatCurrency(orderData.grand_total)}
              bold
            />
          </div>
        </div>
        ...
        <div style={styles.actions}>
          <Link to="/" className="btn" style={styles.btnPrimary}>
            Continue Shopping
          </Link>
          <Link to="/account/orders" className="btn" style={styles.btnOutline}>
            View All Orders
          </Link>
        </div>
      </div>
