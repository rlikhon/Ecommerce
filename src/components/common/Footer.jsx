...
import { Truck, CircleDollarSign, Headphones } from "lucide-react";
...
const Footer = () => {
  ...
  return (
    <footer>
      ...
      <div className="container py-5">
        <div className="row g-4">
          ...
          <div className="col-md-3">
            <img src={LogoWhite} alt="E-Commerce Logo" height="45px" className="mb-3" />
            <p className="text-white-50 small pe-3">
              Subscribe to our newsletter for the latest updates, curated collections, and premium offers.
            </p>
          </div>
          ...
          <div className="col-md-3">
            ...
            <ul className="list-unstyled">
              ...
              <li><Link to="/shop?category=women">Women's Apparel</Link></li>
            </ul>
          </div>
          ...
          <div className="col-md-3">
            ...
            <ul className="list-unstyled">
              ...
              <li><Link to="/checkout">Secure Checkout</Link></li>
              <li><Link to="/cart">View Shopping Cart</Link></li>
            </ul>
          </div>

          {/* Column 4: Social Accounts Connect Layout */}
          <div className="col-md-3">
            <h2 className="mb-3">Follow Us</h2>
            <ul className="list-unstyled">
              <li>
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
                  <svg xmlns="w3.org" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
      ...
      {/* Trust Spotlight Matrix Banner Row */}
      <div className="spotlight py-4">
          ...
          <div className="row g-4 text-center">
            ...
            <div className="col-md-4">
              <div className="spotlight-card">
                ...
                <p className="small mb-0">Applicable on all platform orders over $50</p>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="spotlight-card">
                ...
                <p className="small mb-0">Risk-free product returns verified within 30 days</p>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="spotlight-card">
                ...
                <p className="small mb-0">24/7 internal helpdesk registry assistance</p>
              </div>
            </div>
      ...
      {/* Sub-Footer Copyright Ledger Bar */}
      <div className="copyright-bar py-3 text-center">
        <div className="container">
          <p className="mb-0">
            &copy; {currentYear} E-Commerce Ecosystem Platform. All rights reserved. Designed with Bootstrap 5 SASS.
          </p>
        </div>
      </div>
    </footer>
